...
CREATE DATABASE contract_service_db;
...
GRANT ALL PRIVILEGES ON DATABASE contract_service_db TO admin;
GRANT ALL PRIVILEGES ON DATABASE document_service TO admin;
